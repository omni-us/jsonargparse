...
class SignaturesTests(unittest.TestCase):
    ...
    def test_add_method_arguments(self):
        class MyClass:
            def mymethod(self, a1="1", a2: float = 2.0, a3: bool = False, a4=None):
    ...
    def test_add_subclass_nested_discard_init_args(self):
        ...
        parser = ArgumentParser(exit_on_error=False, logger={"level": "DEBUG"})
        with mock_module(Parent, ChildBase, A, B) as module, self.assertLogs(
            logger=parser.logger, level="DEBUG"
        ) as log:
    ...
    def test_add_subclass_merge_init_args_in_full_config(self):
        ...
        with mock_module(ModelBaseClass, ModelClass) as module:
            ...
            model = yaml.safe_dump({"class_path": "ModelClass", "init_args": {"image_size": 10}})
            config = yaml.safe_dump({"model": {"init_args": {"batch_size": 5}}})
    ...
    def test_basic_subtypes(self):
        def func(a1: PositiveFloat = PositiveFloat(1), a2: Optional[Union[PositiveInt, OpenUnitInterval]] = 0.5):
            return a1, a2
    ...
    def test_print_config(self):
        ...
        self.assertEqual(
            outval["g"], {"a1": {"class_path": "calendar.Calendar", "init_args": {"firstweekday": 0}}, "a2": 7}
        )
...
class SignaturesConfigTests(TempDirTestCase):
    def test_add_function_arguments_config(self):
        def func(a1="1", a2: float = 2.0, a3: bool = False):
            return a1
